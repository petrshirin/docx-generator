...
CERTIFICATION_LIST_TEMPLATES = {
    'рядовой': {
        '3': '.\\Шаблоны рядового\\Аттестационный лист рядового 3.docx',
        '4': '.\\Шаблоны рядового\\Аттестационный лист рядового 4.docx',
        '5': '.\\Шаблоны рядового\\Аттестационный лист рядового 5.docx',
    },
    'сержант': {
        '3': '.\\Шаблоны сержанта\\Аттестационный лист сержанта 3.docx',
        '4': '.\\Шаблоны сержанта\\Аттестационный лист сержанта 4.docx',
        '5': '.\\Шаблоны сержанта\\Аттестационный лист сержанта 5.docx',
    }
}
SERVICE_CHARACTERISTIC_TEMPLATES = {
    'рядовой': {
        '3': '.\\Шаблоны рядового\\Служебная характеристика рядового 3.docx',
        '4': '.\\Шаблоны рядового\\Служебная характеристика рядового 4.docx',
        '5': '.\\Шаблоны рядового\\Служебная характеристика рядового 5.docx',
    },
    'сержант': {
        '3': '.\\Шаблоны сержанта\\Служебная характеристика сержанта 3.docx',
        '4': '.\\Шаблоны сержанта\\Служебная характеристика сержанта 4.docx',
        '5': '.\\Шаблоны сержанта\\Служебная характеристика сержанта 5.docx',
    }
}
...
def create_certifications_lists(template: dict, data_file: str = DATA_FILES[0], dir_to_save: str = DIR_TO_SAVE):
    with open(data_file, newline='', encoding='utf-8') as f:
        ...
        for row in reader:
            docx_file = create_docx_file_by_template(
                DIR_PATH,
                template.get(row['Итог'], template['3']))
            values = [row['ФИОдат'],
                      row['Дата рождения'],
                      row['Место рождения'],
                      row['Факультет'],
